  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
        {[
          { name: "Total Pengguna", value: "1,204", icon: "group", color: "text-emerald-600", bg: "bg-emerald-100/50" },
          { name: "Kamar Terisi", value: "32/50", icon: "key", color: "text-blue-600", bg: "bg-blue-100/50" },
          { name: "Reservasi Aktif", value: "18", icon: "event_available", color: "text-amber-600", bg: "bg-amber-100/50" },
          { name: "Pendapatan Bulan Ini", value: "Rp 124Jt", icon: "trending_up", color: "text-rose-600", bg: "bg-rose-100/50" },
        ].map((stat) => (
      ...
      <div className="mt-8 rounded-2xl bg-white p-8 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)] border border-gray-100 min-h-[400px] flex flex-col items-center justify-center border-dashed border-2">
        <span className="material-symbols-outlined text-[48px] text-gray-300 mb-4">trending_up</span>
