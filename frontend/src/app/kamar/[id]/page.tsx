      ...
      <div className="min-h-screen bg-slate-50 font-sans text-gray-900 flex flex-col">
        ...
        <main className="flex-1 flex items-center justify-center p-6">
          <div className="rounded-3xl bg-white p-10 sm:p-12 text-center shadow-xl border border-gray-200/80 max-w-lg w-full">
            ...
            <Link
              href="/kamar"
              className="mt-6 inline-flex items-center gap-2 rounded-full bg-[#1D4ED8] px-6 py-3 text-xs sm:text-sm font-bold text-white shadow transition-all hover:bg-[#1E3A8A]"
            >
        ...
        <div className="bg-white border-b border-gray-200/80 py-4">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex items-center justify-between">
            ...
            <div className="hidden sm:flex items-center gap-2 text-xs text-gray-500 font-medium">
              ...
              <span>/</span>
              <span className="text-[#1D4ED8] font-bold">{room.name}</span>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between border-b border-gray-200 pb-6">
            <div>
              <div className="flex items-center gap-3">
                <span className="rounded-full bg-[#1D4ED8] px-3.5 py-1 text-xs font-semibold text-white">
                  {room.type}
                </span>
              ...
              <div className="mt-2.5 flex items-center gap-3">
                ...
                <button
                  ...
                  className={`flex h-9 w-9 items-center justify-center rounded-full border transition-all ${isFavorite
            ...
            <div className="text-left md:text-right">
              ...
              <div className="flex items-baseline gap-1 mt-0.5">
                <span className="text-2xl sm:text-3xl font-extrabold text-[#1D4ED8]">
                ...
                <form onSubmit={handleBookingAttempt} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-gray-300 p-2.5 text-xs font-medium text-gray-900 focus:border-[#1D4ED8] focus:outline-none"
                      required
                    />
                  </div>
                  ...
                  <button
                    type="submit"
                    className="w-full rounded-full bg-[#1D4ED8] py-3 text-xs font-bold text-white shadow-md transition-all hover:bg-[#1E3A8A] hover:shadow-lg active:scale-95 mt-2"
                  >
                    Pesan Kamar Ini
                  </button>
                </form>
      ...
      {isLoginModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="w-full max-w-md rounded-3xl bg-white p-6 sm:p-8 text-center shadow-2xl border border-gray-100 relative animate-in fade-in zoom-in duration-200">
            ...
            <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-emerald-100 text-[#1D4ED8] mb-4">
