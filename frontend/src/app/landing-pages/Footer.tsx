...
export default function Footer() {
  ...
  return (
    // Section Footer dengan background Hijau Tua Pekat (#1E3A8A)
    <footer className="w-full bg-[#1E3A8A] text-white pt-16 pb-8 border-t border-emerald-900/60" id="kontak">
        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4 pb-12 border-b border-emerald-800/40">
          ...
          <div>
            ...
            <div className="mt-4 flex items-center gap-3">
              {/* Facebook Icon */}
              <a href="#facebook" aria-label="Facebook" className="flex h-9 w-9 items-center justify-center rounded-full bg-emerald-950 text-emerald-300 hover:bg-[#1D4ED8] hover:text-white transition-colors">
                <svg className="h-4 w-4 fill-current" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                </svg>
              </a>
              {/* Instagram Icon */}
              <a href="#instagram" aria-label="Instagram" className="flex h-9 w-9 items-center justify-center rounded-full bg-emerald-950 text-emerald-300 hover:bg-[#1D4ED8] hover:text-white transition-colors">
                <svg className="h-4 w-4 fill-current" viewBox="0 0 24 24">
              ...
              {/* Youtube Icon */}
              <a href="#youtube" aria-label="Youtube" className="flex h-9 w-9 items-center justify-center rounded-full bg-emerald-950 text-emerald-300 hover:bg-[#1D4ED8] hover:text-white transition-colors">
                <svg className="h-4 w-4 fill-current" viewBox="0 0 24 24">
            ...
            <form onSubmit={handleSubscribe} className="mt-2 flex flex-col gap-2">
              <div className="relative flex items-center">
                ...
                <button
                  type="submit"
                  className="absolute right-1 rounded-lg bg-[#1D4ED8] px-3 py-1.5 text-xs font-semibold text-white hover:bg-emerald-600 transition-colors flex items-center gap-1"
                >
                  <span>Kirim</span>
