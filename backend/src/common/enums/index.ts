// 1. SCHEDULE ENUMS (Status Ketersediaan Slot Jam & Fisik Kamar/Alat)// ============================================================================
...
// 2. BOOKING ENUMS (Status Kontrak Sewa & Operasional Lapangan)
...
// 3. PAYMENT ENUMS (Status Aliran Uang Transaksi)
...
// 4. PAYMENT METHOD ENUMS (Opsi Kanal Pembayaran yang Didukung)
...
// 5. ROLE ENUMS (Hak Akses Pengguna)
export enum Role {
  USER = 'user',
  ADMIN = 'admin',
  STAFF = 'staff',
